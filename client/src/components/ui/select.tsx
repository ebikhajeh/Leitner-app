...
function SelectChevronIcon({
  ...
  return <Icon className={cn("pointer-events-none size-4", className)} />
}
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={<SelectChevronIcon direction="down" className="text-muted-foreground" />}
      />
    </SelectPrimitive.Trigger>
  )
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      {...props}
    >
      <SelectChevronIcon direction="up" />
    </SelectPrimitive.ScrollUpArrow>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      {...props}
    >
      <SelectChevronIcon direction="down" />
    </SelectPrimitive.ScrollDownArrow>
  )
}

SelectChevronIcon.displayName = "SelectChevronIcon"
